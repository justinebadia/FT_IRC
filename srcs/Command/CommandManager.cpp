...
/*   Updated: 2022/08/13 14:26:19 by tshimoda         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	CommandManager::_init_reply_map( void )
{
	...
	_reply_map.insert(std::make_pair(ERR_NOTONCHANNEL, err_notonchannel));				//[442] KICK
	// _reply_map.insert(std::make_pair(ERR_USERDISABLED, *err_userdisabled));			//[446] USERS
	_reply_map.insert(std::make_pair(ERR_NEEDMOREPARAMS, err_needmoreparams));			//[461] USERS_MSG,KICK
	...
	_reply_map.insert(std::make_pair(ERR_CHANOPRIVSNEEDED, err_chanoprivsneeded));		//[482] KICK
